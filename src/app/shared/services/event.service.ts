...
export class EventService {
  ...
  // getEventStats(period: string): Observable<Statistics> {
  //   return this.http.get(this.getEventStatsUrl(period)).map((response: Response) => <Statistics> response.json()).catch(this.handleError);
  // }
